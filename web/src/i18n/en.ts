export default {
  ...
  aesFail: "Aes Encrypt/Decrypt Fail",
  ...
  optionNo: "No",
  optionUnset: "Unset",
  importEmpty: "Paste a TOML document before importing.",
  ...
  importSuccessDescription: "Config imported. Opening the dashboard.",
  aesGcm: "AES-GCM",
  ...
  storage: {
    ...
    empty:
      "No storage configured yet. Use storage for JWT secrets and shared key-value data.",
    name: "Name",

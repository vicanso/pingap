    ...
    case PluginCategory.KEY_AUTH: {
      fields.push(
        ...
        },
        {
          category: "text",
          key: "delay",
          label: t("form.keyAuthFailDelay"),
          id: "key-auth-auth-fail-delay",
          span: 6,
        },
        {
          category: "checkbox",
    ...
    case PluginCategory.BASIC_AUTH: {
      fields.push(
        ...
        },
        {
          category: "text",
          key: "delay",
          label: t("form.basicAuthFailDelay"),
          id: "key-basic-auth-fail-delay",
          span: 6,
        },
        {
          category: "checkbox",
    ...
    case PluginCategory.JWT: {
      fields.push(
        ...
        },
        {
          category: "text",
          key: "delay",
          label: t("form.jwtAuthFailDelay"),
          id: "key-jwt-auth-fail-delay",
          span: 4,
        },
        {
          category: "checkbox",

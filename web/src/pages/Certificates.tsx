...
export default function Certificates() {
  ...
  const items: ExFormItem[] = [
    ...
    },
    {
      ...
      label: certificateI18n("dnsAccessKeyId"),
      placeholder: certificateI18n("dnsAccessKeyIdPlaceholder"),
      defaultValue: certificateConfig.dns_access_key_id,
      span: 3,
      category: ExFormItemCategory.TEXT,
    },
    {
      name: "dns_access_key_secret",
